...
meta.helm.sh/release-name: {{ include "cf-deforestation-reporting-service.chart" . }}
meta.helm.sh/release-namespace: {{ include "cf-deforestation-reporting-service.chart" . }} 
